...
Z.
=======
Ce chapitre décrit la démarche utilisée pour élaborer le cahier des charges et présente les barèmes associés à chacun des objectifs. Il débute par un tableau synthèse du cahier des charges (Table 4.1) ainsi que par la maison de la qualité (Table 4.2), pour ensuite donner place aux descriptions concernant les objectifs et les sous-objectifs. 
>>>>>>> eba9e0bb9287a9c1915a3513c5aafe6e9c5f40a9
...
=======
 La fonction arc tangente est utilisée pour évaluer ce critère, car le champ de vision (FOV) est directement l'arc tangente de la hauteur de l'image et de la longueur focale, le barème correspond au FOV de la caméra divisée par le FOV maximal.  
 
 Le minimum du champ de vision sera 0 degré et le maximum sera de 90 degrés, donc la cote va de 0 à 1. Nous devons garantir que la caméra a un champ de vision adéquat pour le projet, donc le critère a un poids de 7%. 
>>>>>>> eba9e0bb9287a9c1915a3513c5aafe6e9c5f40a9
...
Le système doit permettre d'effectuer les observations sans venir troubler l'environnement de l'animal, il doit pouvoir récupérer toutes les informations qui lui sont nécessaires sans pour autant le retenir contre son gré. Le sujet d'étude doit rester libre de ses mouvements et ne pas être perturbé dans son train de vie. La pondération de ce critère est de 5%. L'évaluation se divisera en 2 catégories pesant 2 points chaque. La première catégorie sera le respect de la liberté de mouvement de l'animal, la seconde sera l'impact sur la vie de l'animal après son passage dans le dispositif. La note de 0/2 sera attribuée pour une mesure qui marque l'animal et l'emprisonne, une note de 1/2 sera attribuée à la mesure qui ne sera pas complètement optimale pour le sujet d'étude et la note de 2/2 sera attribuée au système qui remplit pleinement les conditions des deux catégories, portant la note finale de ce critère à 4/4. 
